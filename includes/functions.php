<?php
	...
	if(isset($_POST['add_user'])){
		...
		if($password != $confirm_password){
			...
			$sql = "INSERT INTO users(FirstName,LastName,UserName,Email,Password,Phone,Address,UserType,Picture)
			values(:fname,:lname,:username,:email,:password,:phone,:address,:usertype,:pic)";
