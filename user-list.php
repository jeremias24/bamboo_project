                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							...
							<div class="col-auto float-right ml-auto">
								<a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_client"><i class="fa fa-plus"></i> Add User</a>
					...
					<div class="row filter-row">
						...
						<div class="col-sm-9 col-md-9">  
							<div class="form-group form-focus">
								<input type="text" class="form-control floating">
								<label class="focus-label">Seller Name</label>
							</div>
						</div>
						<!-- <div class="col-sm-6 col-md-3"> 
							...
							<div class="table-responsive">
								<table class="table table-striped custom-table datatable">
									...
									include ('includes/config.php');
										global $connect;
										$get_pro = "SELECT * FROM users WHERE UserType!='Administrator'";
											...
											<tr>
												<td>
													<h2 class="table-avatar">
														<a href="client-profile.php" class="avatar"><img src="clients/'.$Picture.' alt=""></a>
														<a href="client-profile.php">'.$UserName.'</a>
													</h2>
												</td>
												<td>'.$id.'</td>
